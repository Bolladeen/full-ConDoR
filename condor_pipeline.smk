...
# sanity check first that there is only one input file in each category
...
rule fast_condor:
	...
	params:
		...
		subclonal_mutations = lambda wildcards: f'{config["subclonal_mutations"]}/{wildcards.patient}.subclonal_mutations.yaml',
	log:
