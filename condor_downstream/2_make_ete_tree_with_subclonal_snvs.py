...
manual_snv_dir = Path(
    "/Users/haochenzhang/Iacobuzio_lab/Tapestri_batch2/batch2_data_compiled/manual_annotated_snv_lists"
)
output_dir = Path("../../condor_pipeline/HZ_ete_trees_refined_subclonal_snvs")
output_dir.mkdir(exist_ok=True, parents=True)

patient_name = "RA16_29"
