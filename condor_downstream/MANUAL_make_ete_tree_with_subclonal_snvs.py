...
sample_name_map_f = "/data/iacobuzc/haochen/Tapestri_main_manuscript_analysis/Tapestri_batch2_samples_MASTER_INTERNAL.xlsx"
patient_name = "RA21_17"
condor_tree_pickle = "/data/iacobuzc/haochen/condor_pipeline_trial/condor_outputs/pickle_files/RA21_17_self.solT_cell"
snv_ann_f = "/data/iacobuzc/haochen/Tapestri_main_manuscript_analysis/data_compiled/manual_annotated_snv_lists/RA21_17-patient-all_vars-voi.hz_curated.txt"
output_dir = Path("/data/iacobuzc/haochen/condor_pipeline_trial/condor_downstream/RA21_17")
...
#     if "cell_attachment" in nx_tree.nodes()[n]:
#         print("=====")
#         print(f"node name: {n}")
#         print(f"clone_size: {len(nx_tree.nodes()[n]['cell_attachment'])}")
#         print("=====")
...
try:
    diploid_clone = [l for l in ete_tree.get_leaves() if (l.cn_profile[l.cn_profile>0] == 2).all()][0] # @HZ 2024-05-05 need to remove the non-converged amplicons which have -1
...
leaves_to_merge_to_diploid = merge_clones_into_diploid(
    ...
    rm_clones_with_no_somatic_snv_events=False, # @HZ 2024-04-26
)
